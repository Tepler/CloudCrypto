...
public class CPABEEngineJUnitTest extends TestCase {
    ...
    private void try_valid_access_policy(Pairing pairing, PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
        ...
        try {
            ...
            int row = accessPolicy.length;
            int col = accessPolicy[0].length;
            for(int[] tem:accessPolicy){
                for(int num:tem){
    ...
    private void try_access_policy(Pairing pairing, PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
        ...
        System.out.println("KeyGen and serialization is normal");
        ...
        System.out.println("Encryption and serialization is normal");
        ...
        try{
            ...
            if(anMessage.equals(message)){
                System.out.println("Decryption is normal");
            }
        }catch (Exception e){
            e.printStackTrace();
            System.out.println("Decryption is fail");
        }
...
//        System.out.println("Decryption is normal");
    ...
    public void runAllTests(PairingParameters pairingParameters) {
        try {
            ...
            System.out.println("---------------------------Setup and serialization---------------------------");
            ...
            System.out.println("byteArrayPublicKey:" + byteArrayPublicKey);
            CipherParameters anPublicKey = TestUtils.deserCipherParameters(byteArrayPublicKey);
            System.out.println("anPublicKey:" + anPublicKey);
            ...
            System.out.println("***************************** try_valid_access_policy **********************************");
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_1+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_1_satisfied_1){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            ...
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_1+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_1_satisfied_2){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            try_valid_access_policy(
            ...
            System.out.println("************************************** end *********************************************");
            System.out.println("***************************** try_invalid_access_policy **********************************");
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_1+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_1_unsatisfied_1){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            ...
            System.out.println("***************************** try_invalid_access_policy **********************************");
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_2+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_2_satisfied_1){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            try_valid_access_policy(
            ...
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_2+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_2_satisfied_2){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            try_valid_access_policy(
            ...
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_2+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_2_unsatisfied_1){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            try_invalid_access_policy(
            ...
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_2+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_2_unsatisfied_2){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            try_invalid_access_policy(
            ...
            System.out.println("-----------Policy:"+AccessPolicyExamples.access_policy_example_2+"-----------------");
            System.out.print("------------------Attribute:");
            for(String s:AccessPolicyExamples.access_policy_example_2_unsatisfied_3){
                System.out.print(s + " ");
            }
            System.out.println("--------------------");
            try_invalid_access_policy(
