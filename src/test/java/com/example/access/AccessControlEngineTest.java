...
//		try_valid_access_policy(pairing, 1, AccessPolicyExamples.access_policy_hao_1,
//				AccessPolicyExamples.access_policy_hao_1_satisfied_1);
//		try_valid_access_policy(pairing, 12, AccessPolicyExamples.access_policy_hao_1,
//				AccessPolicyExamples.access_policy_hao_1_satisfied_1_2);
		try_valid_access_policy(pairing, 13, AccessPolicyExamples.access_policy_hao_4,
				AccessPolicyExamples.access_policy_hao_1_satisfied_4);
		try_valid_access_policy(pairing, 14, AccessPolicyExamples.access_policy_hao_5,
				AccessPolicyExamples.access_policy_hao_1_satisfied_5);

//		try_valid_access_policy(pairing, 3, AccessPolicyExamples.access_policy_example_2,
//				AccessPolicyExamples.access_policy_example_2_satisfied_3);

//		try_valid_access_policy(pairing, 4, AccessPolicyExamples.access_policy_example_3,
//				AccessPolicyExamples.access_policy_example_3_satisfied_1);

//		try_valid_access_policy(pairing, 2, AccessPolicyExamples.access_policy_hao_2,
//				AccessPolicyExamples.access_policy_hao_1_satisfied_2);
//		try_valid_access_policy(pairing, 3, AccessPolicyExamples.access_policy_hao_3,
//				AccessPolicyExamples.access_policy_hao_1_satisfied_3);
...
//            System.out.println();
			...
			System.out
					.println("Access Policy with Combined Gate Satisfied Test " + testIndex + ", Error for parsing...");
			e.printStackTrace();
		}
	}
...
//        System.out.println("Reconstruct Secret s = " + reconstructedSecret);
			if (!reconstructedSecret.equals(secret)) {
				System.out.println("Access Policy with Combined Gate Satisfied Test " + testIndex
...
//        System.out.println("Generated Secret s = " + secret);
			...
			System.out.println("Access Policy with Combined Gate Unsatisfied Test " + testIndex
